...
convert_to_indices_9_tile(int *indices);
convert_to_indices_16_tile(int *indices);
convert_to_indices_47_tile(int *indices);

unify_grid_indices(int *base_indices, int *adder_indices);
